        ...
        >
          <div>
            ...
            <p className="text-gray-300 text-base leading-relaxed mb-8">
              An enterprise-grade examination platform built to serve
              educational institutions and certification bodies. The system
              handles 500+ concurrent users with industry-leading security,
            ...
            <div className="flex gap-3">
              <a
                href="https://school-exam-system-9c9b2.web.app/"
                target="_blank"
              ...
              <a
                href="https://github.com/manis-sharma/Secure-Online-Exam-System"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Button
